...
class B
{
	...
	void display(B x)
	{
		System.out.println("The per name is:"+this.name);
		System.out.println("The permenant address is:"+this.address);
		System.out.println("The temp name is:"+x.name);
	...
	public static void main(String[] args)
	{
		...
		{
			System.out.print("Enter your name and   temp address:");
			B ob1=new B(sc.next(),sc.next());
			ob.display(ob1);
		}
